---
title: "exploreproject2"
author: "An Hong Nguyen"
date: "19/09/2018"
...
```{r}
#This will take time, please wait a few seconds...
library(data.table)
library(ggplot2)
path<-getwd()
...
# Three sources (nonpoint, onroad, nonroad) have seen decreases in emissions from 1999-2008 for Baltimore City
```{r}
